...
namespace SpmdParticle
{
    ...
    [AddComponentMenu("SpmdParticle/Renderer")]
    [RequireComponent(typeof(SPWorld))]
    public class SPRenderer : RendererBase
    {
        SPWorld m_world;
        Bounds m_bounds;
        ...
        void Reset()
        {
            m_mesh = AssetDatabase.LoadAssetAtPath<Mesh>("Assets/SpmdParticle/Meshs/cube.asset");
            m_material = AssetDatabase.LoadAssetAtPath<Material>("Assets/SpmdParticle/Materials/SPStandard.mat");
